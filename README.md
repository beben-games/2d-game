...
Status and next steps: `docs/STATUS.md`. Design: `docs/plans/2026-09-02-action-roguelike-design.md`. Plan for Milestones 0 and 1: `docs/plans/2026-09-02-arena-roguelike-m0-m1.md`. Conventions for Claude sessions: `CLAUDE.md`.
