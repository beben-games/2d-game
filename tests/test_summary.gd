...
func test_body_lists_rounds_kills_time_and_seed() -> void:
	var body := SummaryScript.body(2, 4, 17, 83.0, 12345)
	assert_str(body).is_equal("Rounds cleared 2/4\nKills 17\nTime 1:23\nSeed 12345")
...
func test_body_names_the_cheats_when_any_was_on() -> void:
	assert_str(SummaryScript.body(2, 4, 17, 83.0, 12345, "immortal")).is_equal("Rounds cleared 2/4\nKills 17\nTime 1:23\nSeed 12345\nCheats immortal")
	assert_str(SummaryScript.body(2, 4, 17, 83.0, 12345, "")).is_equal("Rounds cleared 2/4\nKills 17\nTime 1:23\nSeed 12345")
