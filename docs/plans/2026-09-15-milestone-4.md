...
- The pause screen: are the options findable, do the sliders feel right, is the build still readable at three quarters of the panel? (`scripts/ui/build_screen.gd`)
