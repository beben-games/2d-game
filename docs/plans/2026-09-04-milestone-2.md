...
func test_door_gap_is_the_pixel_rect_of_the_door_cells() -> void:
	assert_rect(ArenaGrid.door_gap(28, 15, RoomDef.Side.TOP)).is_equal(Rect2(208, 0, 32, 16))
	assert_rect(ArenaGrid.door_gap(28, 15, RoomDef.Side.BOTTOM)).is_equal(Rect2(208, 224, 32, 16))
...
func test_arena_paints_every_cell_and_builds_four_walls() -> void:
	...
	assert_rect(arena.bounds()).is_equal(Rect2(16, 16, 416, 208))
...
- Modify: `scripts/autoload/events.gd`, `scripts/main.gd`, `scenes/main.tscn`, `tests/support/scene_suite.gd`, `tests/test_boot.gd`, `tests/test_spawner_scene.gd`, `tools/smoke.gd`
...
func test_room_builds_arena_and_one_door_per_side_in_use() -> void:
	...
	assert_rect(room.bounds()).is_equal(Rect2(16, 16, 416, 208))
...
Run: `tools/test.sh` twice (expect all green, count now 108 + 7 + 5 minus the two camera tests removed in Task 3), `tools/check_boot.sh`, `tools/smoke.sh idle` and read the PNG: a door with frame and closed leaf centered in the top wall, the knight at the room center.
