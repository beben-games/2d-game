...
- Modify: `scripts/defs/enemy_def.gd`, `scripts/enemy.gd`, `scripts/projectile.gd`, `scenes/projectile.tscn`, `scripts/player.gd`, `scenes/player.tscn`, `data/floors/floor_1.tres`, `tests/support/scene_suite.gd`, `tests/test_enemy_def.gd`, `tests/test_wave_defs.gd`
...
- Shooter: can you always tell a bolt is coming? Is the bolt dodgeable at 120 px/s? (telegraph_time, preferred_range, bolt speed in data/enemies/shooter.tres and data/weapons/shaman_bolt.tres)
