...
Run: `tools/smoke.sh kill`, `tools/smoke.sh room`, `tools/smoke.sh death`, `tools/smoke.sh combat`, `tools/smoke.sh idle`. Read `reports/smoke_room.png` (room 2: door at the bottom behind the knight, closed door at the top, a shaman is not present in the smoke floor) and `reports/smoke_death.png` (the card over the dimmed room).
