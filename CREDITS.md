...
| DungeonUI v1 | 0x72 | https://0x72.itch.io/dungeonui | CC0 (stated on the page) |
| Raven Fantasy Icons, free set | Caio, Clockwork Raven Studios | https://clockworkraven.itch.io/raven-fantasy-icons | Free version: personal use only, meaning projects released for free with no microtransactions or paid ads; no redistribution as a separate product; attribution welcome, not required. A commercial release needs the paid pack (the $5 starter pack or the full collection carries a commercial licence). |
